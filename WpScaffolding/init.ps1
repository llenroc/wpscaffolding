...
else 
{
	...
	if (Test-Path $dllPath) {
        ...
        #Set-DefaultScaffolder -Name CustomTemplate -Scaffolder CustomTemplate -SolutionWide -DoNotOverwriteExistingSetting
        #Set-DefaultScaffolder -Name CustomScaffolder -Scaffolder CustomScaffolder -SolutionWide -DoNotOverwriteExistingSetting
	} 
	else 
	{
